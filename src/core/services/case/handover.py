...
def build_handover_summary(facility, target_date, time_filter, user):
    ...
    Returns dict with keys: shift_label, shift_range, date, stats, highlights

    Refs #1139: Die Übergabe enthält bewusst keine allgemeine Aufgabenliste
    mehr. Offene Aufgaben mit Handlungsbedarf gehören in die Aufgaben-Fokusbox
    (#1128) bzw. die Aufgabenübersicht; übergaberelevante Aufgaben erscheinen
    schichtbezogen in ``highlights``.
    """
