...
def flush_seed_data() -> None:
    ...
    Der gesamte Flush läuft in einer Transaktion: schlägt ein später Schritt
    fehl (z.B. ``ALTER TABLE`` mangels Rechten), bleiben die früheren Deletes
    nicht committed zurück. Refs #1040 (S1).
    """
