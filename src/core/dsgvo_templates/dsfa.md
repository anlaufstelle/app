...
- Endgeräteschutz durch Offline-Kryptografie: Im Browser offline erfasste Daten werden mit AES-GCM-256 verschlüsselt abgelegt. Bei Verlust des Endgeräts sind die Daten ohne Kenntnis des Benutzerpassworts nicht entschlüsselbar; der Schlüssel existiert ausschließlich in-memory und wird bei Logout zerstört (Ref. #573)
