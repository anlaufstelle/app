...
- **Rate-Limit-/Fremd-403 löscht keine Offline-Daten mehr** (#1354) — beim Re-Validieren gecachter Klienten purgt ein 403 (CSRF-/Rate-Limit-/Proxy-Rauschen) den lokalen Bestand nicht mehr wie ein echter Rechteentzug, der wegen des serverseitigen Session-Flushs ohnehin nie als 403 beim Client ankommt; ein 429 bricht die Batch-Re-Validierung sofort ab, statt das Anfragen-Budget weiter zu verbrennen.
