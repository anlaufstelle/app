...
| **MFA-Secrets / Backup-Codes** | C | Postgres `otp_*` (django-otp): TOTP-Secret `otp_totp_totpdevice.key` **Fernet-verschlüsselt** at rest ([ADR-031](adr/031-totp-secret-at-rest.md), Refs #1362); Backup-Codes nur SHA-256-gehasht (#790) | hoch — kompromittiert ⇒ MFA-Bypass |
