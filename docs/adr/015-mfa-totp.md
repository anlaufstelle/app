...
- **Backup-Codes** als sekundärer Faktor: 10 zufällige 128-Bit-Codes (Base32-kodiert), serverseitig **nur als Hash** (`bcrypt`-äquivalent über `StaticDevice.token`) gespeichert. Verbrauchte Codes werden gelöscht; nach 3 verbleibenden Codes nervt das UI bis zum Re-Generate (Refs [#790](https://github.com/tobiasnix/anlaufstelle/issues/790)).
...
- Refs [#521](https://github.com/tobiasnix/anlaufstelle/issues/521) (TOTP-Einführung), [#612](https://github.com/tobiasnix/anlaufstelle/issues/612) (Account-Lockout-Kontext), [#790](https://github.com/tobiasnix/anlaufstelle/issues/790) (Hash-Backup-Codes)
